  ...
  return (
    <SafeAreaProvider>
      <SafeAreaView className="flex-1 p-4">
        ...
        <View className="bg-[#34967c] h-[90px] mb-10 flex-row items-center rounded-md px-7 justify-between">
          <View className="flex-row items-center gap-4">
            <Image source={require('@/assets/images/user-image.png')} />

            <View>
              <Text className="text-xl font-semibold text-white">Rich Xorla</Text>
              <Text className="text-sm font-thin text-white">@xorla_expo</Text>
            </View>
          </View>
        ...
        <View className="h-[350px] gap-3 bg-white rounded-md p-4 mb-4">
            ...
            <Pressable className="flex-row items-center justify-between mb-2">
                <View className="flex-row items-center gap-4">
                    ...
                    <View>
                        <Text className=" text-lg font-semibold mb-2">Saved Beneficiary</Text>
            ...
            <Pressable className="flex-row items-center justify-between mb-2">
                <View className="flex-row items-center gap-4">
                    ...
                    <View>
                        <Text className=" text-lg font-semibold mb-2">Face ID / Touch ID</Text>
                        <Text className=" font-thin text-gray-700">Make Changes to your account</Text>
                    </View>
                </View>
                <MaterialIcons name="keyboard-arrow-right" size={34} color="black" />
            ...
            <Pressable className="flex-row items-center justify-between mb-2">
                <View className="flex-row items-center gap-4">
                    ...
                    <View>
                        <Text className=" text-lg font-semibold mb-2">Log out</Text>
                        <Text className=" font-thin text-gray-700">Further secure your account for safety</Text>
                    </View>
                </View>
                <MaterialIcons name="keyboard-arrow-right" size={34} color="black" />
        ...
        <View className="h-[139px] gap-3 bg-white rounded-md p-4 mb-4">
            <Pressable className="flex-row items-center justify-between mb-2">
                <View className="flex-row items-center gap-4">
                    <View className="w-12 h-12 bg-[#0601B4]/10 items-center justify-center rounded-full ">
                        <MaterialIcons name="notifications-none" size={24} color="#0601B4" />
                    </View>
                    <View>
            ...
            <Pressable className="flex-row items-center justify-between mb-2">
                <View className="flex-row items-center gap-4">
                    <View className="w-12 h-12 bg-[#0601B4]/10 items-center justify-center rounded-full ">
                        <MaterialIcons name="favorite-border" size={24} color="#0601B4" />
                    </View>
                    <View>
                        <Text className=" text-lg font-semibold mb-2">About App</Text>
                    </View>
                </View>
                <MaterialIcons name="keyboard-arrow-right" size={34} color="black" />
            </Pressable>
